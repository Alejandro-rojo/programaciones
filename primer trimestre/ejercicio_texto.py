...
# buscar=text.find("Doña Uzeada de Ribera")
# buscar2=text.find("os. Sortijas celestes y azules le ahorcaban las falanges")
# print(buscar)
# extraer=text[buscar:buscar2]
# print(extraer)
# pregunta=input("dime una parte del texto: ")
# uscar=text.find(pregunta)
# print(uscar)
